package com.zdnst.common.mybatis.interceptor;
...
import com.zdnst.common.mybatis.page.Dialect;
import com.zdnst.common.mybatis.page.MySql5Dialect;
import com.zdnst.common.mybatis.page.OracleDialect;
import com.zdnst.common.mybatis.page.Page;
import com.zdnst.common.mybatis.page.PageContext;
import com.zdnst.common.mybatis.page.ReflectHelper;
import com.zdnst.common.utils.Tools;
        ...
        if (parameterMappings != null) {  
            ...
            for (int i = 0; i < parameterMappings.size(); i++) {  
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT) {  
                    ...
                    } else if (propertyName.startsWith(Tools.ITEM_PREFIX)&& boundSql.hasAdditionalParameter(prop.getName())) {  
